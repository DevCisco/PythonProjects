...
x_entry.grid(column=1, row=0,sticky=tk.EW, padx=5, pady=5)
...
y_entry.grid(column=1, row=1,sticky=tk.EW, padx=5, pady=5)
calculate_button=ttk.Button(frame, text="Verifica", command=verifycell)
